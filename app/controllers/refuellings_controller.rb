class RefuellingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @refuelling.save
        update_mileage(@refuelling.mileage)
  ...
  private
    ...
    def refuelling_params
      params.require(:refuelling).permit(:petrol_station_id, :description,
        :total_price, :liters, :mileage, :date_time).merge(:car_id => @@car_id)
    end
end
